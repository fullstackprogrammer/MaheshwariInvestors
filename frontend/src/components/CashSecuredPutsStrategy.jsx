        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-dark-surface border-b border-dark-border sticky top-0">
              <th className="px-3 py-2 text-left cursor-pointer hover:bg-dark-border transition-colors" onClick={() => handleSort('ticker')}>Ticker {getSortIcon('ticker')}</th>
              <th className="px-3 py-2 text-right cursor-pointer hover:bg-dark-border transition-colors" onClick={() => handleSort('current_stock_price')}>Price {getSortIcon('current_stock_price')}</th>
              <th className="px-3 py-2 text-right cursor-pointer hover:bg-dark-border transition-colors" onClick={() => handleSort('market_cap_b')}>Market cap {getSortIcon('market_cap_b')}</th>
              <th className="px-3 py-2 text-right cursor-pointer hover:bg-dark-border transition-colors" onClick={() => handleSort('put_strike')}>Strike {getSortIcon('put_strike')}</th>
              <th className="px-3 py-2 text-right cursor-pointer hover:bg-dark-border transition-colors min-w-[7.5rem]" onClick={() => handleSort('expiration')}>Expiry {getSortIcon('expiration')}</th>
              <th className="px-3 py-2 text-right">Bid</th>
              <th className="px-3 py-2 text-right">Ask</th>
              <th className="px-3 py-2 text-right">Mid</th>
              <th className="px-3 py-2 text-right cursor-pointer hover:bg-dark-border transition-colors" onClick={() => handleSort('return_dollars')}>Return $ (1 contract) {getSortIcon('return_dollars')}</th>
              <th className="px-3 py-2 text-right cursor-pointer hover:bg-dark-border transition-colors" onClick={() => handleSort('cash_required')}>Cash req (1 contract) {getSortIcon('cash_required')}</th>
              <th className="px-3 py-2 text-right cursor-pointer hover:bg-dark-border transition-colors" onClick={() => handleSort('return_pct')}>Return % {getSortIcon('return_pct')}</th>
              <th className="px-3 py-2 text-right cursor-pointer hover:bg-dark-border transition-colors" onClick={() => handleSort('annualized_return_pct')}>Ann. Return % {getSortIcon('annualized_return_pct')}</th>
              <th className="px-3 py-2 text-right">Breakeven (expiry)</th>
              <th className="px-3 py-2 text-right cursor-pointer hover:bg-dark-border transition-colors" onClick={() => handleSort('pct_downside_to_strike')}>% to Strike {getSortIcon('pct_downside_to_strike')}</th>
